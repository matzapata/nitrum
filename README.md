...
- [ ] Tighter attestation / cert story (e.g. issued cert in attestation where applicable)
- [ ] Env vars support (e.g. POST bootstrap, authority public key baked into image)
